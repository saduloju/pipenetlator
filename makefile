...
C++FLAGS =  -c -w
#
OBJECTS = scan.o  main.o trace.o debug.o user_messages.o error_messages.o   \
          read_project.o process_number.o create_vectors.o vectors_free.o   \
		  process_reservoir.o parameters.o properties.o process_node.o      \
		  check_LDH.o process_LDH.o external.o initial_heads.o convergence.o\
		  linkup.o iterations.o output.o output_data.o output_results.o     \
		  process_solve.o data_check.o solution_status.o solve_data.o       \
		  compute_fvec.o compute_f.cc compute_Jmat.o compute_j.o solver.o   \
		  compute_flows.o
#
project1 : ${OBJECTS}
...
process_node.o     : process_node.cc prototypes.h header.h arrays.h scanlib.h
check_LDH.o        : check_LDH.cc prototypes.h header.h arrays.h scanlib.h
process_LDH.o      : process_LDH.cc prototypes.h header.h arrays.h scanlib.h
